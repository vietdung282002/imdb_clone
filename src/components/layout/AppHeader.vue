      ...
      <div class="header-content">
        ...
        <div class="menu-button">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            class="ipc-icon ipc-icon--menu ipc-responsive-button__icon" viewBox="0 0 24 24" fill="currentColor"
            role="presentation">
        ...
        <div class="header-actions">
          ...
          <div class="language-dropdown">
            <button class="action-button" type="button">
              <span>EN</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="dropdown-icon" viewBox="0 0 24 24"
                fill="#fff" role="presentation">
                <path fill="none" d="M0 0h24v24H0V0z"></path>
                <path
